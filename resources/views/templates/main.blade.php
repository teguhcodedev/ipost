...
<head>
    ...
    <title>Chublife Telesystem</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/shared/aris.css') }}">
    <link rel="stylesheet" href="{{ asset('css/main/style.css') }}">
    <link rel="stylesheet" href="{{ asset('css/main/softphone.css') }}">
...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center" style="padding-bottom:80px">
                <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}">
                    {{-- <img src="{{ asset('icons/logo.png') }}" alt="logo" /> </a> --}}
                    <img width="40px" height="70px" style="border-radius:50%"
                        src="{{ asset('images/logo/logo-99.png') }}" style="margin-bottom: 10px; margin-top:10px" alt="logo-tele" />
                </a>
                <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}">
                    <img src="{{ asset('images/logo/logo-99.png') }}" alt="logo" />
                </a>
            </div>
                  ...
                  @if ($notif->stok != 0) --}}
                            <a class="dropdown-item preview-item py-3">
                                ...
                                <div class="preview-item-content">
                                    <h6 class="preview-subject font-weight-normal text-dark mb-1">Barang Hampir Habis
                                    </h6>
                            ...
                            <a class="dropdown-item preview-item py-3">
                                ...
                                <div class="preview-item-content">
                                    <h6 class="preview-subject font-weight-normal text-dark mb-1">Barang Telah Habis
                                    </h6>
                    ...
                    <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
                        <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown"
                            ...
                            <img class="img-xs rounded-circle"
                                src="{{ asset('chubb_foto/' . auth()->user()->foto) }}" alt="Profile image"> </a>
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            <div class="dropdown-header text-center">
                                <img class="img-md rounded-circle"
                                    src="{{ asset('chubb_foto/' . auth()->user()->foto) }}" alt="Profile image">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                   ...
                   <li class="nav-item">
                       <a class="nav-link" href="{{ url($item->MENU_URL) }}">
                   ...
                   @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/chubblife-dashboard') }}">
            ...
            @endphp --}}
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="kelola_akun">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/account') }}">Register Account</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/access') }}">Authorisation</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#upload_distribution" aria-expanded="false"
                            aria-controls="kelola_laporan">
                            <span class="menu-title">Upload dan Distribution Data</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="upload_distribution">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/upload') }}">Upload Data</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/distribution') }}">Distribution Data</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/recall') }}">ReCall Data</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#customerlist" aria-expanded="false"
                            aria-controls="kelola_laporan">
                        ...
                        <div class="collapse" id="customerlist">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/newcustomerlist') }}">New Customer LIst</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="">Scedule Customer List</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="">Others Customer List</a>
                                </li>
                                <li class="nav-item">
                                    @include('templates.coba')
                                </li>
                            </ul>
                        </div>
                    </li>
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper" id="content-web-page">
                    ...
                    <a class="open-button" onclick="openForm()">
                        <img src="{{ asset('images/softphone.png') }}" alt="logo" width="80px" height="80"/>
                    </a>
                </div>
    ...
    <!-- Javascript -->
    <script src="{{ asset('js/templates/softphone.js') }}"></script>
